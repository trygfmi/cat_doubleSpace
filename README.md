...
<div class="wp-block-group">
<p>上記のコマンドをインストール済みの方は、以下のコマンドを実行してリポジトリからダウンロード後、ディレクトリを移動し、シェルスクリプトを実行してcatコマンドで取得した文字列の空白がどうなるか確認してみてください</p>
...
<pre class="wp-block-code has-background" style="background-color:#ffeeee"><code>/hello/cat/command/hello world/test string.png
/hello/cat/command/hello world/test  string.png</code></pre>
</details>
</div>
...
<pre class="wp-block-code has-24292-eff-color has-text-color has-background has-1-125-rem-font-size" style="background-color:#ffeeee"><code>/hello/cat/command/hello world/test string.png
/hello/cat/command/hello world/test  string.png</code></pre>
</details>
</div>
</details>
